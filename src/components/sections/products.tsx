      ...
      <div className="mx-auto max-w-[1600px] px-[60px] lg:px-[80px]">
        ...
        >
          {products.map((product) => (
            <div
              key={product.name}
              className="product-card group relative flex flex-col overflow-hidden  bg-[#1C1C1C] border border-white/[0.04] transition-all duration-700 hover:border-[#D8A441]/20 hover:shadow-[0_0_60px_rgba(216,164,65,0.1)] hover:-translate-y-2"
            >
              <div className="relative aspect-[1/1] overflow-hidden bg-[#161616]">
                ...
                <div className="absolute inset-0  ring-0 transition-all duration-700 group-hover:ring-[0.5px] group-hover:ring-[#D8A441]/25" />
              </div>
